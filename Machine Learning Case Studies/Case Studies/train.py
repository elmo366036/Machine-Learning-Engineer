...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=2, metavar='IN',
                       help='number of input_dim features (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='HID',
                       help='number of hidden_dim feature (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                       help='number of output_dim (default: 1)')
